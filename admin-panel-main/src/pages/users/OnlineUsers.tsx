...
export function OnlineUsers() {
  ...
  return (
    <div className="space-y-6">
      {/* flex-wrap: the four action buttons overflowed phone screens and
          forced page-wide horizontal scrolling (which also made the filters
          below feel broken). Desktop keeps the same single-row layout. */}
      <div className="flex flex-wrap justify-between items-center gap-3 bg-white p-4 rounded-lg shadow">
