...
import { getPublicMaintenance, type PublicMaintenance } from '@/lib/api/publicConfig';

const POLL_MS = 30_000;

/**
 * Full-screen overlay when admin enables site maintenance mode.
 * Blocks interaction on the user panel while still allowing read-only browsing.
 */
    ...
    >
      <div className="max-w-md w-full rounded-xl bg-white p-8 text-center shadow-2xl">
        ...
        <p className="mt-4 text-xs text-gray-400">
          Betting and games are temporarily unavailable. Please check back soon.
        </p>
      </div>
    </div>
  );
